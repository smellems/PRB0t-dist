...
var Octokit = class {
  ...
  static plugin(...newPlugins) {
    ...
    }, __publicField(_a3, "plugins", currentPlugins.concat(
...
__reExport(crypto_node_exports, require("crypto"));
...
var OAuthApp = (_a = class {
  constructor(options) {
    ...
    __publicField(this, "getUserOctokit");
    __publicField(this, "getWebFlowAuthorizationUrl");
    __publicField(this, "createToken");
    __publicField(this, "checkToken");
    __publicField(this, "resetToken");
    __publicField(this, "refreshToken");
    __publicField(this, "scopeToken");
    __publicField(this, "deleteToken");
    __publicField(this, "deleteAuthorization");
...
}, __publicField(_a, "VERSION", VERSION13), _a);
...
var App = (_a2 = class {
  constructor(options) {
    ...
    __publicField(this, "getInstallationOctokit");
    __publicField(this, "eachInstallation");
    __publicField(this, "eachRepository");
    __publicField(this, "getInstallationUrl");
    __publicField(this, "log");
...
}, __publicField(_a2, "VERSION", VERSION15), _a2);
...
function PullRequest(branchFromUser = process.env.PR_BRANCH_FROM_USER, branchFromRepo = process.env.PR_BRANCH_FROM_REPO, branchFromBranch = process.env.PR_BRANCH_FROM_BRANCH ?? DEFAULT_BRANCH_FROM, token) {
  ...
  const gh = new Octokit2({ auth: token }).rest;
  const configuration = {
    files: [],
    commitMessage: "",
    titlePullRequest: "",
  ...
  const createFork = async (state) => {
    ...
    const check = async (retry2 = 0) => {
      ...
      try {
        ...
        console.log(`Waiting for console to be created, retry: ${retry2}`);
        await new Promise((resolve) => setTimeout(resolve, 1e3));
        await check(retry2 + 1);
      }
    };
    await check();
  };
